    ...
    <section class="list_emp">
        ...
        <?php for ($i = 1; $i <= 10; $i++): ?>
            <article<?php if ($i % 2 == 0) echo ' class="right"'; ?>>
                <header>
                    <div class="img thumb_emp"></div>
                    <hgroup>
                        <h1><a target="_blank" href="../artigo/uri-do-artigo" title="Ver Post">UPINSIDE TECNOLOGIA</a></h1>
                        <h2><a target="_blank" href="../filtrarcidade" title="Ver Post">Soledade/RS</a></h2>
                    </hgroup>
                </header>
