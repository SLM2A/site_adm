...
CREATE TABLE `vagaaluguel` (
  ...
  `formaAluguel` varchar(50) DEFAULT NULL,
  `preco` varchar(50) DEFAULT NULL,
  `itemAlugado` varchar(50) DEFAULT NULL,
  `tamanho` varchar(50) DEFAULT NULL,
  `diaFuncionamento` varchar(50) DEFAULT NULL,
  `horarioFuncionamento` varchar(50) DEFAULT NULL,
  `caracteristica` text,
  `diferencial` text
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
