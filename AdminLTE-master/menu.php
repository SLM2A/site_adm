      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
			  <ul class="sidebar-menu">
				...
				<li class="active treeview">
					<a href="menu.php?exe=index"><i class="fa fa-dashboard"></i><span>Inicio</span></a>
				</li>
				<li class="treeview">
					<a href="cadPerfil/perfilpublico"><i class="fa fa-user"></i> <span>Perfil</span></a>	
				</li>	
				<li class="treeview">
					<a href="procurarvaga"><i class="fa fa-search"></i> <span>Procurar vaga</span></a>	
				</li>
				<li class="treeview">
					<a href="cadPerfil/sobremim.html"><i class="fa fa-spinner"></i> <span>Atualizar Perfil</span></a>	
				</li>
				<li class="treeview">
					<a href="cadEmpresa/minhaempresa.html"><i class="fa fa-building"></i> <span>Minhas Empresas</span></a>	
				</li>
			  </ul>
        </li>             
      </ul>
